	...
	<div class="panel panel-default">
		...
		<div class="panel-body">
			...
			<div class="pull-right" style="line-height: 32px;">
				<button class="btn flat-btn -blue -sm" v-on="click: selectAnotherPlan">
	...
	<div class="panel panel-default">
		...
		<div class="panel-body">
			...
			<form class="form-horizontal" role="form">
				...
				<div class="form-group">
					<div class="col-md-6 col-md-offset-3">
						<button type="submit" class="btn flat-btn -blue -sm" v-on="click: subscribe" v-attr="disabled: subscribeForm.subscribing">
